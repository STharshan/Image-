...
const services = [
  {
    title: "The Maintenance Clean",
    desc: `keep your vehicle spotless, inside and out, ensuring it looks great and stays well-maintained.`,
    image: "/carpaint.avif",
  ...
  },
  {
    title: "Detailing",
    desc: `
Showroom shine that protects your paint and makes your car stand out.
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[67%] mt-25 mx-auto h-15 object-cover"
                    onError={(e) => {
